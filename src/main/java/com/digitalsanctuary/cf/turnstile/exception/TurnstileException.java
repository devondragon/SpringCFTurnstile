 ...
 * <p>
 * This exception serves as the parent class for all specific Turnstile exceptions. It provides common functionality and allows for catching all
 * Turnstile exceptions with a single catch block if desired.
 * </p>
 */
